...
The model with 2 components has an ICL value of `r mod1@bestResult@criterionValue`. 
The model with 1 component has an ICL value of `r mod2@bestResult@criterionValue`. 
...
Limited data. Same data used to generate h0 was used to test.
